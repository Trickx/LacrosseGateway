...
public:
  Nextion();
  bool Begin(ESP8266WebServer *webServer, ESP8266SoftSerial *softSerial, unsigned long baud, bool addUnits);
  void Handle(WSBase::Frame frame, unsigned int framesPerMinute, String version, int32_t rssi, bool fhemIsConnected, bool bridge1Connected, bool bridge2Connected);
